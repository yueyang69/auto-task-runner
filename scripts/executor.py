...
def execute_step_local(step: dict, workspace=None) -> dict:
    """
    本地执行命令（备用方案，不通过模型）
    ...
    try:
        # 如果有工作区，在工作区目录下执行
        cwd = str(workspace.workspace_path) if workspace else None
